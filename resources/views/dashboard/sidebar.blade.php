<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="{{route('create.category')}}"><i class='bx bx-radio-circle'></i>create category</a>
						</li>
						<li> <a href="{{route('index.category')}}"><i class='bx bx-radio-circle'></i>show all categories</a>
						</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{ route('create.product') }}"><i class='bx bx-radio-circle'></i>Add New Product</a>
						</li>
						<li> <a href="{{ route('index.product') }}"><i class='bx bx-radio-circle'></i>Show All Products</a>
						</li>
					</ul>
				</li>
